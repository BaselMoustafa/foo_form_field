...
class GetPaginatedMultiSelectionFormFieldExample extends StatefulWidget {
  const GetPaginatedMultiSelectionFormFieldExample({super.key});

  @override
  State<GetPaginatedMultiSelectionFormFieldExample> createState() =>
      _GetPaginatedMultiSelectionFormFieldExampleState();
}

class _GetPaginatedMultiSelectionFormFieldExampleState
    extends State<GetPaginatedMultiSelectionFormFieldExample> {
  late final PaginatedMultiSelectionFieldController<Product> _controller;
  ...
  void initState() {
    ...
    _controller = PaginatedMultiSelectionFieldController<Product>(
        ...
        child: ExampleScreen(
          ...
          children: [
            ControllerTestButtons(
              title: "Get Paginated Multi Selection Controller Test Buttons",
              controller: _controller,
              firstDummyValue: [
              ...
              secondDummyValue: [
                ...
                Product(id: 4, name: "Product 4", price: 400, description: "Description 4"),
              ],
